...
public class SharedDataManager {
    ...
    private init() {
        guard let sharedDefaults = UserDefaults(suiteName: suiteName) else {
            print("🔸 SharedDataManager: Failed to create UserDefaults with suite name \(suiteName). Falling back to standard.")
            self.userDefaults = UserDefaults.standard
            return
        }
        self.userDefaults = sharedDefaults
        print("✅ SharedDataManager: Successfully initialized with App Group: \(suiteName)")
    }
